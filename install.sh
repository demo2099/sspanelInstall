...
install_main(){
    ...
    wget https://raw.githubusercontent.com/demo2099/sspanelInstall/main/master/docker-compose.yml     
    blue "配置文件获取成功"
...
install_main2(){
    ...
    wget https://raw.githubusercontent.com/demo2099/sspanelInstall/main/dev/docker-compose.yml     
    blue "配置文件获取成功"
    greenbg "首次启动会拉取镜像，国内速度比较慢，请耐心等待完成"
    docker-compose up -d
    notice2
